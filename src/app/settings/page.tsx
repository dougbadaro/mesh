...
import { Settings, User, Shield, AlertTriangle, Terminal } from "lucide-react"
...
export default async function SettingsPage() {
  ...
  // Convertendo Decimal para number para evitar erro de serialização
         ...
         <div className="md:col-span-8 space-y-8">
            ...
            <section className="space-y-4">
                <div className="flex items-center gap-2 text-zinc-200">
                    ...
                    <h3 className="text-sm font-bold uppercase tracking-widest">Financial Parameters</h3>
                </div>
                <CreditCardSettings 
            ...
            <section className="space-y-4">
                 <div className="flex items-center gap-2 text-zinc-200">
                    <Terminal size={16} className="text-emerald-500" />
                    <h3 className="text-sm font-bold uppercase tracking-widest">Category Schema</h3>
                </div>
                <CategoryManager 
